  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-white to-blue-100">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 lg:gap-12">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left px-2 sm:px-0">
              ...
              <a href="https://bpolytix.in" target="_blank" rel="noopener noreferrer"
                ...
                <span className="px-2 py-0.5 rounded-full bg-blue-50 text-[10px] tracking-wider uppercase font-bold">Collab</span>
                BPOLYTIX is powered by SocialMoon
      ...
      <Section className="py-10 bg-white border-y border-gray-100">
        <Container>
          <div className="rounded-2xl bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 p-[1px] shadow-lg">
            <div className="rounded-2xl bg-white px-4 py-5 md:px-6 md:py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-center flex-wrap gap-2 text-sm md:text-base">
                <span className="px-2.5 py-1 rounded-full bg-slate-900 text-white text-xs font-bold tracking-wide">PARTNERSHIP</span>
                <span className="w-7 h-7 rounded-full bg-white border border-blue-100 flex items-center justify-center overflow-hidden shadow-sm">
                  <Image src="/logo_bpolytix.png" alt="BPOLYTIX logo" width={22} height={22} className="object-contain" />
                </span>
                <span className="font-bold text-gray-900">BPOLYTIX</span>
                <span className="text-gray-400 font-semibold">powered by</span>
                <span className="font-bold text-blue-700">SocialMoon</span>
              </div>
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 text-white text-sm font-semibold hover:bg-blue-900 transition-colors"
                >
                  Visit bpolytix.in
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="px-4 py-2.5 h-auto rounded-xl border-gray-300 text-gray-700 hover:bg-gray-50"
                  onClick={() => window.open('/contact', '_self')}
                >
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-white font-black text-xl leading-tight">Meet Avena</span>
      ...
      {/* Testimonials Section — hidden, restore by setting SHOW_TESTIMONIALS = true */}
